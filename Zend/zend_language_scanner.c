/* Generated by re2c 0.13.5 on Thu Feb  2 23:16:45 2012 */
...
yyc_ST_VAR_OFFSET:
	{
		...
		if (yych <= '/') {
			if (yych <= ' ') {
				if (yych <= '\f') {
					if (yych <= 0x08) goto yy842;
					if (yych <= '\n') goto yy838;
					goto yy842;
				} else {
					if (yych <= '\r') goto yy838;
					if (yych <= 0x1F) goto yy842;
					goto yy838;
				}
			} else {
				if (yych <= '$') {
